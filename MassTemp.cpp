...
int main()
{
	...
	if (Aint == Bint) std::cout << "ðàâíû" << std::endl;
	else std::cout << "íå ðàâíû" << std::endl;
	...
	if (Aint == Dint) std::cout << "ðàâíû" << std::endl;
	else std::cout << "íå ðàâíû" << std::endl;
	...
	while (n < 0)
	{
		std::cout << "ââåäèòå ÷èñëî n ýëåìåíòîâ: " << std::endl;
		std::cin >> n;
		if (n < 0) std::cout << "÷èñëî ìåíüøå 0" << std::endl;
	}
	...
	if (Gint.FindKey(1) != -1) std::cout << "1 âõîäèò â ìàññèâ" << std::endl;
	else std::cout << "1 íå âõîäèò â ìàññèâ" << std::endl;
	if(Gint.FindKey(10) != -1) std::cout << "10 âõîäèò â ìàññèâ" << std::endl;
	else std::cout << "10 íå âõîäèò â ìàññèâ" << std::endl;
